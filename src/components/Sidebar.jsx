...
const Sidebar = () => {
  return (
    <div className="flex flex-col gap-4">
      ...
      <button className="hidden xl:inline w-48 h-9 mt-4 rounded-full text-white bg-indigo-400 hover:brightness-95 shadow-md cursor-pointer transition-all duration-300 ease-in-out">
        Sign In
      </button>
    </div>
  );
